...
<body>
    <div class="full">
        <div class="left">
            <div class="image">
                <img src="./img_Member/LanPhuong.jpg" alt="gfg-logo" style="width:100px;height:100px;">
            </div>
            <div class="Contact">
                <h2>Thông tin cá nhân</h2>
                <p><b>Email:</b>lanphuong@gmail.com</p>
                <p><b>Số điện thoại:</b>0355587440</p>
            </div>
            <div class="Skills">
                <h2>KỸ NĂNG</h2>
                <ul>
        ...
        <div class="right">
            ...
            <div class="Experience">
                <h2>Kinh nghiệm</h2>
                <h3>Thực tập tại công ty FPTEdu</h3>
