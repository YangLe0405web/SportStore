    ...
    <div class="app">
        ...
        <ul class="pagination justify-content-center">
            ...
            if ($current_page > 1 && $so_trang > 1) {
                echo '<a  class="page-link" href="?thamso=baitapp3&bai=6&trang=' . ($current_page - 1) . '">Trước</a>';
            }
            for ($i = 1; $i <= $so_trang; $i++) {
                $link_phan_trang = "?thamso=baitapp3&bai=6&trang=" . $i;
                if ($i == $current_page) {
            ...
            if ($current_page < $so_trang && $so_trang > 1) {
                echo '<a class="page-link" href="?thamso=baitapp3&bai=6&trang=' . ($current_page + 1) . '">Sau</a>';
            }
            ?>
