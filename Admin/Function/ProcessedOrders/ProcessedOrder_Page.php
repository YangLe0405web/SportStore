...
include("./Function/ProcessedOrders/Handle.php");
?>

<?php
$query = "SELECT *,Sum(chitietdathang.SoLuong) as 'TongSanPham' FROM dondathang join KhachHang on dondathang.MaKH = KhachHang.MaKH join chitietdathang ON chitietdathang.SoDH = dondathang.SoDH  WHERE  dondathang.TinhTrangGiaoHang = 'Giao hàng thành công' GROUP BY dondathang.SoDH";
...
<div class="container-fluid ">
    ...
    <div class="card p-3">
        <h1 class="font-weight-bold text-center"> ĐƠN ĐẶT HÀNG ĐÃ GIAO THÀNH CÔNG</h1>
    </div>
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <form action="" method="post">
                                                        ...
                                                        <input type="hidden" name="D_SoDH" id="D_SoDH" value="<?php echo $row['SoDH']; ?>">

                                                        <div class="form-group">

                                                            <label>Xoá đơn hàng <span class="text-danger font-weight-bold"> <?php echo $row['SoDH']; ?></span>  ?</label>
